...
# COMPENDIUM
compendium_path="$DOOMWADDIR/compendium/Compendium-v1a.pk3"
#compendium_path2="$DOOMWADDIR/compendium/compen-play.pk3"
...
# SAVE FILE DIRECTORY
save_dir="$HOME/.config/uzdoom/savegames/compendium"
