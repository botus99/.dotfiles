...
brutal_doom_path="$DOOMWADDIR/brutalv22/brutalv22beta3.5.pk3"
...
# DOOM 64
doom64_path="$DOOMWADDIR/doom-64-retribution/D64RTR[v1.5].WAD"
...
ENABLE_VKBASALT=1 uzdoom.appimage -iwad "$iwad_path" -file "$doom64_path" "$rain_and_snow_path" -savedir "$save_dir" -config "$config_path"
