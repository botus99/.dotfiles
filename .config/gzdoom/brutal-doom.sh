...
# MUSIC
#
#doom_metal_path="$HOME/.wads/music/DoomMetalVol6.wad"
#doom_2016_music_path="$HOME/.wads/music/doom-2016/DOOMIIHellOnEarth_DOOMEternal_OST.pk3"
doom_2016_music_path="$HOME/.wads/music/doom-2016/TheUltimateDoom_DOOM(2016)_OST.pk3"
...
#
gzdoom -iwad "$iwad_path" -file "$brutal_doom_path" "$doom_2016_music_path" "$tourretes_guy_path" "$rain_and_snow_path" "$cats_visor_base_path" "$cats_visor_path" -savedir "$save_dir"
