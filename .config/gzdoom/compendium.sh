...
# SAVE FILE DIRECTORY
save_dir="$HOME/.config/gzdoom/savegames/compendium"

# custom config locataion
config_path="$HOME/.config/gzdoom/configs/compendium.ini"
...
gzdoom -iwad "$iwad_path" -file "$dhtp_path" "$beautiful_path" "$brutal_doom_path" "$compendium_path" "$rain_and_snow_path" -savedir "$save_dir"
